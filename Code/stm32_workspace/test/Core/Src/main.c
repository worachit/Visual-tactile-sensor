...
//  HAL_DCMI_Start_DMA(&hdcmi, DCMI_MODE_SNAPSHOT, (uint32_t)image, sizeof(image));
////  status = OV5640_CAMERA_Driver.GetAWBRGBGain(&p_cam, RGBGain);
//  HAL_Delay(500);
...
//  {
//	  HAL_UART_Transmit(&huart2, image, 65535, 10000);
//	  HAL_UART_Transmit(&huart2, image+65535, sizeof(image)-65535, 10000);
//  }
//  else
//  {
//	  HAL_UART_Transmit(&huart2, image, sizeof(image), 10000);
//  }
//  HAL_Delay(500);
  /////////////////////////////////////////
